---
title: "Week 2 IBDS: Surfing Science"
...
# Problem we want to solve for the day--

-   How do we do scholarly research?
-   How do we organize and communicate our ideas?

# Goals for the day

There are two tasks for the day and two tools we want to learn how to use.

## Task one (two parts):

1.  What is Behavioural Science?
2.  List some questions in the domain of behavioural science that you want to know the answer to.
...
-   You don't have to find the answer, you have to find something that will tell you how to search for what you want to find out.
